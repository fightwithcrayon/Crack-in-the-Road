...
export default {
  ...
  computed: {
    source () {
      return this.$props.src.replace(/www.crackintheroad.com/g, 'admin.crackintheroad.com')
    },
    sourceset () {
      return this.$props.srcset.replace(/www.crackintheroad.com/g, 'admin.crackintheroad.com')
    }
  },
	mounted () {
