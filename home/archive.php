	...
	<article class="archive block">
		<div class="image">
			<a href="<?php the_permalink(); ?>" name="<?php echo $post->post_title ?>">
				<img src="<?php echo get_small_thumbnail_url($post->ID); ?>" data-srcset="<?php echo $image; ?>" alt="<?php echo $post->post_title; ?>" title="<?php echo $post->post_title; ?>" class="lazyload blur-up" />
			</a>
		</div>
		<div class="info">
